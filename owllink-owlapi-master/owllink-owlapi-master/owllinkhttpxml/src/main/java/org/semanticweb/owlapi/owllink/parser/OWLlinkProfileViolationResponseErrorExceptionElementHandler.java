...
public class OWLlinkProfileViolationResponseErrorExceptionElementHandler extends AbstractOWLlinkErrorHandler<OWLlinkProfileViolationErrorResponseException>{
    ...
    @Override
    public OWLlinkProfileViolationErrorResponseException getOWLLinkObject() throws OWLXMLParserException {
        return new OWLlinkProfileViolationErrorResponseException(getErrorString());
    }
}
