 ...
 * Date: 26.02.2010
 */
public class OpenlletServerFactory implements OWLlinkServerFactory {
    ...
    static void usage() {
        System.out.println("Openllet (for OWLAPI v5) as OWLlink Server");
        System.out.println("OWLlink server that is backed by Pellet reasoner");
        System.out.println("");
        System.out.println("Usage: java OpenlletServerFactory [-port portNum]");
    ...
    public static void main(String args[]) {
        ...
        OpenlletServerFactory factory = new OpenlletServerFactory();
