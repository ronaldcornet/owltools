...
public class OWLlinkHTTPXMLReasoner extends OWLReasonerBase implements OWLlinkReasoner {
    ...
    public void precomputeInferences(InferenceType... inferenceTypes)
        ...
        for (InferenceType type : inferenceTypes) {
            ...
            if (InferenceType.CLASS_HIERARCHY == type) {
                classify();
            }
        }
    }
    ...
    public boolean isPrecomputed(InferenceType inferenceType) {
        throw new OWLlinkUnsupportedMethodException("This reasoner does not support verifying if precomputation has happened.");
    }
