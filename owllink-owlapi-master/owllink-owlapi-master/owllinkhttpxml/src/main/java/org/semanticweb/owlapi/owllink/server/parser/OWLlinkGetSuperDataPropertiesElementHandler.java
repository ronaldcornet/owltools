 ...
 * Date: 25.10.2009
 */
public class OWLlinkGetSuperDataPropertiesElementHandler
        extends AbstractOWLPropertyRequestElementHandler<SetOfDataPropertySynsets, GetSuperDataProperties> {
    ...
    @Override
    public GetSuperDataProperties getOWLObject() throws OWLXMLParserException {
        return new GetSuperDataProperties(super.kb, (OWLDataProperty) super.o, direct);
    }
}
