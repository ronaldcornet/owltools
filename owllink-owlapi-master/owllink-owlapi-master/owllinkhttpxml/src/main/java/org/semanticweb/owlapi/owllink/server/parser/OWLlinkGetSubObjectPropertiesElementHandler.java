...
public class OWLlinkGetSubObjectPropertiesElementHandler extends AbstractOWLPropertyRequestElementHandler<SetOfObjectPropertySynsets, GetSubObjectProperties> {
    ...
    @Override
    public GetSubObjectProperties getOWLObject() throws OWLXMLParserException {
        return new GetSubObjectProperties(super.kb, (OWLObjectPropertyExpression) super.o, direct);
    }
}
