 ...
 * Date: 28.11.2009
 */
public class OWLlinkGetFlattenedObjectPropertyTargetsElementHandler extends AbstractOWLIndividualElementHandler<SetOfIndividuals, GetFlattenedObjectPropertyTargets> {
    protected boolean isNegative = false;
    protected OWLObjectPropertyExpression property;

    /** @param handler handler */
    public OWLlinkGetFlattenedObjectPropertyTargetsElementHandler(OWLXMLParserHandler handler) {
        super(handler);
    }
    ...
    @Override
    public GetFlattenedObjectPropertyTargets getOWLObject() throws OWLXMLParserException {
        return new GetFlattenedObjectPropertyTargets(getKB(), getObject(), property, isNegative);
    }
}
