...
/**
 * Represents a <a href="http://www.owllink.org/owllink-20091116/#IndividualConstantDataPropSynsets">GetDataPropertyTargets</a>
 * request in the OWLlink specification. * Author: Olaf Noppens
 * Date: 23.10.2009
 */
public class GetDataPropertyTargets extends AbstractKBRequestWithOneObject<
        SetOfLiterals,
        OWLDataProperty> {
